...
import ma.ensa.backendhealthforce.payload.request.SignupRequest;
...
import ma.ensa.backendhealthforce.repository.UserRepository;
import ma.ensa.backendhealthforce.security.jwt.JwtUtils;
import ma.ensa.backendhealthforce.security.services.UserDetailsImpl;
...
public class AuthController {
  ...
  public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
    ...
    User user = new User(signUpRequest.getUsername(),signUpRequest.getTelephone(),signUpRequest.getGenre(),signUpRequest.getDate(),
